...
public class GetPostAdapter_ExtraPromotionFragment extends RecyclerView.Adapter<GetPostAdapter_ExtraPromotionFragment.ViewHolder> {
   ...
   String last="abc";
    ...
    public GetPostAdapter_ExtraPromotionFragment(Activity activity, List<GetCart_Result> task) {
